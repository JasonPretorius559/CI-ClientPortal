    ...
    <Card className="p-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-ink-500">Case record</p>
          ...
          <p className="mt-2 text-sm text-ink-500">Case ID: {id || "Not assigned"}</p>
        </div>
        {id ? (

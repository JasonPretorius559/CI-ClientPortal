  ...
  return (
    <div>
      ...
      <input
        ...
        className={cn(
          "mt-1.5 block min-h-11 w-full rounded-md border border-ink-300 bg-white px-3 py-2 text-sm text-ink-950 shadow-sm placeholder:text-ink-400 focus:border-ink-950 focus:ring-2 focus:ring-ink-200",
